              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    message: { type: 'string', example: 'Cet email est déjà utilisé ou le rôle spécifié n\'existe pas' }
                  }
                }
              }
            }
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  message: { type: 'string', example: "L'id de la chambre n'est valide." }
                }
              }
            }
          }
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  message: { type: 'string', example: "Aucune chambre n'a été trouvée." }
                }
              }
            }
          }
